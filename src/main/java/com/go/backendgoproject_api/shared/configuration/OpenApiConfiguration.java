package com.go.backendgoproject_api.shared.configuration;
    ...
    public OpenAPI customOpenApi(
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .termsOfService("https://acme-Backend.com/tos")
                        .license(new License().name("Apache 2.0 License").url("https://acme-backend.com/license"))
                        .contact(new Contact()
